...
Stages: Not contacted yet → Missed call 1/2 → Meeting booked → After meeting → Interested in demo → Demo send → Written message send → Contact later → In process → **Win** / **Lost**.
